...
def train(model, data_loader, train_optimizer, epoch, epochs, batch_size=32, temperature=0.5, device='cuda:3'):
	...
	for data_pair in train_bar:
		...
		feat_left, out_left = model(x_i)
		feat_left, out_right = model(x_j)
