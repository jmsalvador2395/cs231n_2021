...
def sample_noise(batch_size, dim, seed=None):
	...
	return torch.zeros(batch_size, dim).uniform_(-1, 1)
...
def ls_discriminator_loss(scores_real, scores_fake):
	...
	dev = scores_real.device
	loss = .5*torch.mean((scores_real-1)**2 + (scores_fake)**2)
